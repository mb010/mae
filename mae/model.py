...
#         :param n_channels: Number of channels in input data
#         :param patch_size: Patch size for encoder
#         :param masking_ratio: Masking ratio for MAE - controls the proportion of patches masked
#         :param enc_dim: Dimension of encoder
#         :param enc_heads: Number of heads for encoder
#         :param enc_mlp_dim: MLP dimension for encoder
#         :param dec_dim: Dimension of decoder
#         :param dec_heads: Number of heads for decoder
#         :param dec_depth: Depth of decoder
#         :param dec_dim_head: Dimension of decoder heads
#         for prediction.
#         """
#         super().__init__()
#         self.save_hyperparameters()  # save hyperparameters for easy inference
